 ...
 * StarFrame.java
 *
 * Created on Jul 26, 2014, 1:01:53 AM
 */
...
public class StarFrame extends javax.swing.JFrame
{
    ...
    public StarFrame() throws IOException 
    {
        initComponents();
        add(new StarPanel2());
        //jPanel1 = new StarPanel2();
        //repaint();
    }
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                ...
                {
                    Logger.getLogger(StarFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
